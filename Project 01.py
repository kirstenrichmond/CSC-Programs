...
for i in range(h): #when i is in the range of the height    
    print (bb * (i +1)) #this will print thecharacter times i +1
...
height = levels #naming the height  
 
h = height #simplifying the height to h
...
for i in range(h): #when i is in the range of h
    print (" " *(h-i-1) + bb* (2*i+1))  #this will print a space, with
#he-1-i characters plus the building block character creating the pyramid
